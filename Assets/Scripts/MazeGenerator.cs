...
public class MazeGenerator : MonoBehaviour {
	...
	void Start ()
    {
        ...
        Vector3 off = new Vector3(-MazeRows / 2, 0, MazeColumns / 2);
    ...
    void InitMaze()
    {
        ...
        for (int r = 0; r < MazeRows; r++)
        {
            for (int c = 0; c < MazeColumns; c++)
            {
                ...
                //create Floor
                vec.Set(floorPos.x + (c), floorPos.y, floorPos.z - r);
                rot = Quaternion.Euler(0, 0, 0);
                ...
                {
                    //create WestWall
                    vec.Set(pos.x + (c) - (scale.x / 2), pos.y, pos.z - (r) - (scale.x / 2));
                ...
                vec.Set((pos.x + (c) + (scale.x) - (scale.x / 2)), pos.y, pos.z - (r) - (scale.x / 2));
                rot = Quaternion.Euler(0, 90, 0);
